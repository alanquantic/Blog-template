...
export interface Page {
  id: number;
  title: string;
  layout: (HeroBlock | ContentBlock | MediaBlockType | CallToActionBlock | ArchiveBlock | CodeBlock)[];
  /**
   * URL-friendly identifier. Auto-generated from the title if left empty.
   */
  slug: string;
  /**
   * Original WordPress ID. Set by the migration script to make re-runs idempotent.
   */
...
export interface Post {
  ...
  extraBlocks?: (ContentBlock | MediaBlockType | CodeBlock)[] | null;
  categories?: (number | Category)[] | null;
